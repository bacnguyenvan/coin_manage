...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="widget-content-left">
                                            <div class="btn-group">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a href="{{route('admin-logout')}}" tabindex="0" class="dropdown-item">Logout</a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="app-sidebar sidebar-shadow">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="{{route('coins-list')}}" class="mm-active">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Dashboard
                                    </a>
                                </li>
                                <li class="app-sidebar__heading">Manage coin</li>
                                <li
                                    >
                                    <a href="#">
      ...
      {{-- <div class="fb-customerchat" attribution=setup_tool page_id="100122498529978"
          theme_color="#fa3c4c"
